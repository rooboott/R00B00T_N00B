...
echo -e "${RED}                  ~ Tools for Hacking by R00B00T_N00B ${NC}"
echo ""
echo -e "${YELLOW} http://R00B00T_N00B.in | https://facebook.com/R00B00T_N00B | https://github.com/rooboott ${NC} "
echo ""
echo "---------------------------------------------------------------------------------------"
echo ""
...
echo "[✔] Installing ...";
echo "";
git clone https://github.com/rooboott/hackerpro.git "$INSTALL_DIR";
echo "#!/bin/bash
